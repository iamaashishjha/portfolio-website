            ...
            <div class="top-bar">
                ...
                <div class="intro-x dropdown w-8 h-8 relative">
                    <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in">
                        ...
                        <img alt="Midone Tailwind HTML Admin Template" src="{{ asset('storage/').'/'.Auth::user()->profile_image }}">
                        @else
                    ...
                    <div class="dropdown-box mt-10 absolute w-56 top-0 right-0 z-20">
                        <div class="dropdown-box__content box bg-theme-38 text-white">
                            ...
                            <div class="p-2">
                                <a href="{{ route('admin.profile', Auth::user()->id) }}" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 rounded-md"> <i data-feather="user" class="w-4 h-4 mr-2"></i> Profile </a>
