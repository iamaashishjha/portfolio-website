...
@section('meta')
    <meta property="og:title" content="{{ $saying->title }}">
    @isset($saying->image)
        <meta property="og:image" content="{{ asset($saying->image) }}">
    @endisset
    <meta name="title" content="{{ $saying->title }}">
    <meta name="author" content="{{ $saying->createdByEntity->name }}">
