    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            ...
            <div class="intro-y box">
                <div
                    class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 {{ isset($category) ? 'bg-theme-9 text-white' : 'bg-theme-1 text-white' }}">
                        ...
                        <div class="preview">
                            <div>
                                ...
                                <input type="text" id="title" name="title"
                                    class="{{ isset($category) ? ' cursor-not-allowed  bg-gray-100 ' : '' }} input w-full border mt-2 @error('title') border-theme-6 @enderror"
                            ...
                            <div class="mt-5 mb-5">
                                <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                                    ...
                                    <input
                                        ...
                                        {{ isset($category) ? $category->checkStatus() : '' }}>
                                </div>
                            </div>
                            <div class="mt-3">
                                <h5
                                    class="text-lg ext-theme-9 @error('category_image') text-theme-6 @enderror font-medium leading-none">
                                    Category Image Upload <span
                                        class="text-lg ext-theme-9 text-theme-6 font-medium leading-none">*</span></h5>
                                <div
                                    class="border-2 border-dashed rounded-md mt-2 pt-4 @error('category_image') border-theme-6 @enderror">
                                    <div class="flex flex-wrap px-4">
                                        <div class="w-24 h-24 relative image-fit mb-5 mr-5 cursor-pointer zoom-in">
                                            <img class="rounded-md"
                                                alt="{{ isset($category) ? $category->description : '' }}"
                                                src="{{ isset($category) ? $category->image : '/ar/dist/images/preview-6.jpg' }}"
                                                id="category-image">
                                        </div>
                                    </div>
                            ...
                            <div class="mt-3">
                                ...
                                <input type="text" id="meta_description" name="meta_description"
                                    ...
                                    value="{{ isset($category) ? $category->meta_description : old('meta_description') }}"
                                    readonly>
                            </div>
                            <div class="mt-3">
                                ...
                                <input type="text" id="keywords" name="keywords"
                                    ...
                                    value="{{ isset($category) ? $category->keywords : old('keywords') }}" readonly>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <input type="text" id="meta_title" name="meta_title"
                                    ...
                                    value="{{ isset($category) ? $category->meta_title : old('meta_title') }}" readonly>
                            </div>
                            <div class="mt-6 text-center">
                                <button type="submit"
                                    class="button w-50 mr-1 mb-2 {{ isset($category) ? 'bg-theme-3 text-white' : 'bg-theme-9 text-white' }}">{{ isset($category) ? 'Update Category' : 'Create New Category' }}</button>
