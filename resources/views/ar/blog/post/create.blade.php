...
@section('title')
{{ isset($post) ? 'Edit New Blog Post ' . '"' . $post->title . '". | Aashish Jha' : 'Create New Blog Post | Aashish Jha' }}
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex">
    <a href="{{ route('post.index') }}" class="">Blog Post</a>
...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        ...
        <a class="button text-white bg-theme-9 shadow-md mr-2" href="{{ route('post.index') }}">All Blog Posts</a>
        <a class="button text-white bg-theme-6 shadow-md mr-2" href="{{ route('post.trashed') }}">Trashed Blog Posts</a>
