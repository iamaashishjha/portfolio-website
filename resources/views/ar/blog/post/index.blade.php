        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            ...
            <a class="button text-white bg-theme-6 shadow-md mr-2" href="{{ route('admin.blog.post.trashed') }}">Trashed
                ...
                <a class="button text-white bg-theme-9 shadow-md mr-2" href="{{ route('admin.blog.category.index') }}">Blog Category</a>
                    ...
                    <a class="button text-white bg-theme-1 shadow-md mr-2" href="{{ route('admin.blog.post.create') }}">
                        <i class="fa fa-plus mx-2" aria-hidden="true"></i>
                        Create New
                        Blog Post
                    </a>
                    <a class="button text-white bg-theme-6 shadow-md mr-2" href="{{ route('admin.blog.post.trashed') }}">
                        <i class="fa fa-trash mx-2" aria-hidden="true"></i>
                        Trashed
                        Blog Posts
                    </a>
                    <a class="button text-white bg-theme-9 shadow-md mr-2" href="{{ route('admin.blog.category.index') }}">
                        <i class="fa fa-th-large mx-2" aria-hidden="true"></i>
                        Blog Category
                    </a>
                    <a class="button text-white bg-theme-12 shadow-md mr-2" href="{{ route('admin.blog.tag.index') }}">
