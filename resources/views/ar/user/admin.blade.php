    ...
    <table class="table table-report table-report--bordered display datatable w-full" id="datatable">
        <thead>
            <tr>
                ...
                <th class="border-b-2 text-center  whitespace-no-wrap">User Name</th>
            ...
            <tr>
                ...
                <td class="border-b w-5">
                    <div class="flex sm:justify-center items-center">
                        ...
                        <a class="flex items-center text-theme-6" href="javascript:;" data-toggle="modal" data-target="#delete-modal-preview-{{ $user->id }}"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
                    </div>
                </td>
            </tr>
