...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex">
    ...
    <a href="" class="breadcrumb--active">All Header/Footer</a>
</div>
@endsection
...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        <a class="button text-white bg-theme-1 shadow-md mr-2" href="{{ route('admin.home.headerFooter.create') }}">Create New Header/Footer</a>
            ...
            <tr>
                ...
                <td class="border-b w-5">
                    <div class="flex sm:justify-center items-center">
                        <a class="flex items-center mr-3" href="{{ route('admin.home.headerFooter.edit', $headerFooter->id) }}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                        <a class="flex items-center text-theme-6" href="javascript:;" data-toggle="modal" data-target="#delete-modal-preview-{{ $headerFooter->id }}"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
                    </div>
                </td>
            </tr>
            <div class="modal" id="delete-modal-preview-{{ $headerFooter->id }}">
                <div class="modal__content">
                    ...
                    <div class="px-5 pb-8 text-center">
                        <form action="{{ route('admin.home.headerFooter.destroy', $headerFooter->id) }}" method="post">
                            @csrf
                            @method('DELETE')
