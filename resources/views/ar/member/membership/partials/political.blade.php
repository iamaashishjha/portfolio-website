	...
	<div class="tab-content__pane p-5 active" id="old-membership-content">
		...
		<h1 class="text-4xl text-theme-9 font-medium leading-none mt-2 mb-2 text-center">Political
			Details
			(राजनैतिक विवरण |)
		</h1>
		<hr class="mt-5 mb-5">
		...
		<div class="grid grid-cols-3 gap-2">
			<div class="mt-3">
				<div
					class="font-medium flex items-center @error('party_post') text-theme-6 @enderror">
					Haisiyat
					<span
			...
			<div class="mt-3">
				<div
					class="font-medium flex items-center @error('party_lebidar') text-theme-6 @enderror">
					मासिक लेवी दर
					<span
						class="text-lg ext-theme-9 text-theme-6 font-medium leading-none ml-1">*</span>
				</div>
		...
		<div class="mt-3">
			<div
				class="font-medium flex items-center @error('party_location') text-theme-6 @enderror">
				Party Location
				<span
					class="text-lg ext-theme-9 text-theme-6 font-medium leading-none ml-1">*</span>
			</div>
