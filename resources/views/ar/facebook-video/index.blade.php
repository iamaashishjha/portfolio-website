...
@section('content')
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        @if ($authUser->hasPermissionTo('create facebookvideo'))
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex">
                                ...
                                @if ($authUser->hasPermissionTo('update facebookvideo'))
                                ...
                                <div class="modal" id="edit-modal-{{ $video->id }}">
                                    <div class="modal__content">
                                        ...
                                        <form action="{{ route('admin.facebook-video.update', $video->id) }}" method="post"
                                            ...
                                            <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                                                ...
                                                <div class="col-span-12 sm:col-span-12">
                                                    <label>Iframe</label> <input type="text"
                                                        class="input w-full border mt-2 flex-1"
                                                        placeholder="Video Title" name="iframe"
                                                        value="{{ $video->iframe }}">
                                                </div>
                                            </div>
                                ...
                                <!-- END: Edit Modal -->
                                @if ($authUser->hasPermissionTo('delete facebookvideo'))
                                    ...
                                    <div class="modal" id="delete-modal-preview-{{ $video->id }}">
                                        <div class="modal__content">
                                            <div class="p-5 text-center"> <i data-feather="x-circle"
                                                ...
                                                <div class="text-gray-600 mt-2">Do you really want to delete this post?
                                                </div>
                                            </div>
                                            <div class="px-5 pb-8 text-center">
                                                <form action="{{ route('admin.facebook-video.destroy', $video->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    ...
                                                    <button type="submit"
                                                        class="button w-24 bg-theme-6 text-white">Trash</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal" id="create-modal">
        <div class="modal__content modal__content--lg ">
            ...
            <form action="{{ route('admin.facebook-video.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
