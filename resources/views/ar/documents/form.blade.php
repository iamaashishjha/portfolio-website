...
@section('content')
    <div class="intro-y flex items-center mt-8 ">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a class="button text-white bg-theme-9 shadow-md mr-2" href="{{ route('admin.document.index') }}">
                ...
                <form
                    ...
                    <div class="col-span-12 md:col-span-6">
                        <div class="p-5 preview">
                            ...
                            <input type="text" name="meta_description"
                                ...
                                value="{{ isset($document) ? $document->meta_description : old('meta_description') }}"
                                required readonly>
                        </div>
                    </div>
                    <div class="col-span-12 md:col-span-6">
                        <div class="p-5 preview">
                            ...
                            <input type="text" name="keywords"
                                ...
                                value="{{ isset($document) ? $document->keywords : old('keywords') }}" required readonly>
                        </div>
                    </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-wrap px-4">
                                    <div class="w-24 h-24 relative image-fit mb-5 mr-5 cursor-pointer zoom-in">
                                        <img class="rounded-md" alt="{{ isset($document) ? $document->description : '' }}"
                    ...
                    <div class="col-span-12 md:col-span-6">
                        <div class="p-5 preview text-center">
                            <button type="submit"
                                class="button w-50 mr-1 mb-2 {{ isset($document) ? 'bg-theme-3 text-white' : 'bg-theme-9 text-white' }}">{{ isset($document) ? 'Update Document' : 'Create New Document' }}</button>
                        </div>
                    </div>
                </form>
            </div>
