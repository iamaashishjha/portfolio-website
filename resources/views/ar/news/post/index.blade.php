...
@section('title')
All News Posts | Nagrik Unmukti Party
@endsection
...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        ...
        <a class="button text-white bg-theme-1 shadow-md mr-2" href="{{ route('admin.news.post.create') }}">Create New
            News Post</a>
        <a class="button text-white bg-theme-6 shadow-md mr-2" href="{{ route('admin.news.post.trashed') }}">Trashed
            News Posts</a>
    </div>
</div>
<!-- BEGIN: Datatable -->
            ...
            <tr>
                ...
                <td class="border-b w-5">
                    <div class="flex sm:justify-center items-center">
                        <a class="flex items-center mr-3" href="{{ route('admin.news.post.edit', $post->id) }}"> <i
