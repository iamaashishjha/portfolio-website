...
@section('content')
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a class="button text-white bg-theme-1 shadow-md mr-2" href="{{ route('admin.news.post.create') }}">
                <i class="fa fa-plus mx-2" aria-hidden="true"></i>
                Create New
                News Post
            </a>
            <a class="button text-white bg-theme-6 shadow-md mr-2" href="{{ route('admin.news.post.trashed') }}">
            ...
            <a class="button text-white bg-theme-9 shadow-md mr-2" href="{{ route('admin.news.category.index') }}">
                <i class="fa fa-th-large mx-2" aria-hidden="true"></i>
                News Category
            </a>
                ...
                @if ($posts->count() > 0)
                    @foreach ($posts as $post)
                        <tr>
                            ...
                            class="w-4 h-4 mr-2"></i> {{ $post->created_at->format('H:i:s A Y-m-d') }} </div> --}}
                            </td>
                            <td class="border-b w-5">
                                <div class="flex sm:justify-center items-center">
                                    <a class="flex items-center mr-3"
                                        href="{{ route('admin.news.post.edit', $post->id) }}"> <i
