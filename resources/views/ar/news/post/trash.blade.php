...
@section('title')
    Trashed News Posts || {{ __('base.title') }}
@endsection

@section('breadcum')
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex">
        <a href="{{ route('admin.news.post.index') }}" class="">Blogs</a>
...
@section('content')
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            ...
            <a class="button text-white bg-theme-1 shadow-md mr-2" href="{{ route('admin.news.post.create') }}">Create New
                News Post</a>
            <a class="button text-white bg-theme-6 shadow-md mr-2" href="{{ route('admin.news.post.index') }}">All News
                Posts</a>
                <a class="button text-white bg-theme-9 shadow-md mr-2" href="{{ route('admin.news.category.index') }}">
                    News Category
                </a>
                <a class="button text-white bg-theme-12 shadow-md mr-2" href="{{ route('admin.news.tag.index') }}">
                    News Tag
                </a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="border-b w-5">
                                <div class="flex sm:justify-center items-center">
                                    <a class="flex items-center text-theme-9 mr-3" href="javascript:;" data-toggle="modal"
                                        data-target="#restore-modal-preview-{{ $post->id }}"> <i
                                            data-feather="check-square" class="w-4 h-4 mr-1"></i> Restore </a>
                        ...
                        <div class="modal" id="delete-modal-preview-{{ $post->id }}">
                            <div class="modal__content">
                                ...
                                <div class="px-5 pb-8 text-center">
                                    <form action="{{ route('admin.news.post.destroy', $post->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
