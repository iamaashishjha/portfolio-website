<div class="tab-content__pane p-5 active" id="personal-content">
	...
	<div class="grid grid-cols-3 gap-2">
		...
		<div class="mt-3">
			<div
				class="font-medium  @error('category') text-theme-6 @enderror  flex items-center">
				वर्ग
				<span
					class="text-lg ext-theme-9 text-theme-6 font-medium leading-none ml-1">*</span>
			</div>
			<div class="">
				<input type="text"
					...
					placeholder="Write Full Name (पुरा नाम लेख्नुहोस |)" name="category"
					id="category"
		...
		<div class="mt-3">
			<div
				class="font-medium  @error('blood_group') text-theme-6 @enderror  flex items-center">
