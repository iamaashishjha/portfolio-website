<div class="tab" id="property-content">
	<div class="px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200 ">

		{{-- Income --}}
		<h1 class="text-4xl text-theme-9 font-medium leading-none mt-2 mb-2 text-center">Income
			Details (आय
			विवरण |)</h1>
		<hr class="mt-5 mb-5">
		...
		<hr class="mt-5 mb-5">
		<h1 class="text-4xl text-theme-6 font-medium leading-none mt-2 mb-2 text-center">Property
			Details
			(सम्पति बिबरण |)
		</h1>
		<hr class="mt-5 mb-5">
