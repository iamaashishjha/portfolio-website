<div class="tab-content__pane p-5 active" id="citizenship-content">
	...
	<div>
		<div class="grid grid-cols-3 gap-2">
			...
			<div class="mt-3 mr-2">
				<label
					class="font-medium mt-3 @error('temp_province_id') text-theme-6 @enderror">
					Province (प्रदेश)
					<span
						class="text-lg ext-theme-9 text-theme-6 font-medium leading-none">*</span>
				</label>
				<div class="mt-2">
					<select data-placeholder="प्रदेश छान्नुहोस् |" class="select2 w-full"
						name="temp_province_id" id="temp_province_id"
						onchange="getDistrict('temp')">
						<option hidden>प्रदेश छान्नुहोस्</option>
						@foreach ($provinces as $province)
							<option value="{{ $province->id }}"
			...
			<div class="mt-3 mr-2">
				<label
					class="font-medium mt-3 @error('temp_district_id') text-theme-6 @enderror">
					District (जिल्ला)
					<span
						class="text-lg ext-theme-9 text-theme-6 font-medium leading-none">*</span>
				</label>
		...
		<div class="grid grid-cols-3 gap-2">
			...
			<div class="mt-3 ml-2 mr-2">
				...
				<input type="text"
					class="intro-y input input--lg w-full box pr-10 placeholder-theme-13 ml-2 mt-3"
					placeholder="Write Ward Number" name="temp_ward_number"
					id="temp_ward_number"
