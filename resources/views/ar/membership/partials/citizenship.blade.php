<div class="tab-content__pane p-5 active" id="citizenship-content">
	...
	<div class="grid grid-cols-12 gap-2">
		...
		<div class="col-span-12 lg:col-span-6">
			...
			<input type="text" class="intro-y input input--lg w-full box pr-10 placeholder-theme-13  mt-3"
	...
	<div class="grid grid-cols-12 gap-2">
		<div class="col-span-12 lg:col-span-4">
			...
			<div class="mt-2">
				<select data-placeholder="लिङ्ग छान्नुहोस् |" class="select2 w-full" name="gender_id" id="gender_id">
	...
	<div class="grid grid-cols-3 gap-2">
		...
		<div class="col-span-12 lg:col-span-4">
			<div class="font-medium mt-3   @error('passport_number') text-theme-6 @enderror  flex items-center">
				Passport Number
			</div>
			<input type="text" class="intro-y input input--lg w-full box pr-10 placeholder-theme-13  mt-"
		...
		<div class="col-span-12 lg:col-span-4">
			<div class="font-medium mt-3   @error('voter_id_number') text-theme-6 @enderror  flex items-center">
				Voter Id Number
			</div>
			<input type="text" class="intro-y input input--lg w-full box pr-10 placeholder-theme-13  mt-"
	...
	<div>
		<div class="grid grid-cols-12 gap-2">
			...
			<div class="col-span-12 lg:col-span-4">
				...
				<div class="mt-3">
					...
					<div class="mt-2">
						<select data-placeholder="पहिला जिल्ला छान्नुहोस् |" class="select2 w-full  mt-3"
		...
		<div class="grid grid-cols-12 gap-2">
			...
			<div class="col-span-12 lg:col-span-4">
				<div class="mt-3 mr-2">
					<div
						class="font-medium mt-3   @error('perm_local_level_type_id') text-theme-6 @enderror  flex items-center">
						Local Level Type (प्रदेश)
						<span class="text-lg ext-theme-9 text-theme-6 font-medium leading-none">*</span>
					</div>
					<div class="mt-3">
						<select data-placeholder="पहिला स्थानीय तह छान्नुहोस् |" class="select2 w-full  mt-3"
			...
			<div class="col-span-12 lg:col-span-4">
				{{-- Tole Name --}}
				<div class="mt-3 ">
					<div class="font-medium mt-3   @error('perm_tole') text-theme-6 @enderror  flex items-center">
						{{-- <i data-feather="chevron-down" class="w-4 h-4 mr-2"></i> --}}
						Tole (टोल)
						<span class="text-lg ext-theme-9 text-theme-6 font-medium leading-none ml-1">*</span>
					</div>
