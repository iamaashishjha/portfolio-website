	...
	<div class="tab-content__pane p-5 active" id="documents-content">
		...
		<div class="grid grid-cols-3 gap-2">
			...
			<div class="mt-3">
				...
				<div class="mt-5">
					<div
						class="rounded-md pt-4 @error('citizenship_front') border-theme-6 @enderror">
						<div class="flex flex-wrap px-4">
							<div
								class="w-24 h-24 relative image-fit mb-5 mr-5 cursor-pointer zoom-in">
								<img class="rounded-md"
			...
			<div class="mt-3">
				...
				<div class="mt-5">
					<div
						class="rounded-md pt-4 @error('passport_front') border-theme-6 @enderror">
						<div class="flex flex-wrap px-4">
							<div
								class="w-24 h-24 relative image-fit mb-5 mr-5 cursor-pointer zoom-in">
								<img class="rounded-md"
				...
				<div class="mt-5">
					<div class="rounded-md pt-4 @error('pan_back') border-theme-6 @enderror">
						...
						<div class="px-4 pb-4 flex items-center cursor-pointer relative">
							...
							<input type="file"
								class="w-full h-full top-0 left-0 absolute opacity-0"
								onchange="panBack(event)" name="pan_back"
								value="{{ old('pan_back') }}">
						</div>
					</div>
				</div>
