...
@section('title')
    Trashed Thought || {{ __('base.title') }}
@endsection

@section('breadcrumb')
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex">
        <a href="{{ route('admin.thought.index') }}" class="">Blogs</a>
...
@section('content')
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            ...
            <a class="button text-white bg-theme-1 shadow-md mr-2" href="{{ route('admin.thought.create') }}">Create New
               Thought</a>
            <a class="button text-white bg-theme-6 shadow-md mr-2" href="{{ route('admin.thought.index') }}">All Thought</a>
                    ...
                    @foreach ($posts as $post)
                        ...
                        <div class="modal" id="restore-modal-preview-{{ $post->id }}">
                            <div class="modal__content">
                                ...
                                <div class="px-5 pb-8 text-center">
                                    <form action="{{ route('admin.thought.restore', $post->id) }}" method="post"
