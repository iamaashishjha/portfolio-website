...
@endphp
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12">
            <form
                action="{{ isset($goverment) ? route('admin.goverment.update', $goverment->id) : route('admin.goverment.store') }}"
                ...
                <div class="intro-x box">
                    <h2 class="text-4xl font-medium leading-none m-3 p-4 text-theme-6">
                        {{ isset($goverment) ? 'Edit ' . $goverment->title : 'Create goverment' }}
                    </h2>
                </div>
                    ...
                    <div class="intro-y col-span-12 lg:col-span-8">
                        ...
                        <div class="pt-5 px-5 preview" id="input">
                            ...
                            <input type="text" class="input w-full border mt-2" placeholder="Enter Title" name="title"
                                ...
                                value="{{ isset($goverment->title) ? $goverment->title : old('title') }}">
                        </div>
                        <!-- END: Input -->
                        <!-- BEGIN: Input -->
                        <div class="pt-5 px-5 preview" id="input">
                            ...
                            <input type="file" class="input w-full border mt-2" placeholder="Enter File" name="file"
                                ...
                                value="{{ isset($goverment->file) ? $goverment->file : old('file') }}">
                        </div>
                        <!-- END: Input -->
                        <!-- BEGIN: Input -->
                        <div class="pt-5 px-5 preview" id="input">
                            ...
                            <textarea id="message" rows="6" class="input w-full border mt-2" name="description"
                                placeholder="Write description here...">
                                        {{ isset($goverment->description) ? $goverment->description : null }}
                            </textarea>
                        </div>
                        <!-- END: Input -->
                    </div>
                        ...
                        <div class="border border-gray-200 dark:border-dark-5 rounded-md p-5 mt-5">
                            <div class="w-40 h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                <img class="rounded-md" alt="Midone Tailwind HTML Admin Template"
                                    src="{{ isset($goverment->image) ? $goverment->image : '/ar/dist/images/profile-6.jpg' }}"
                                    id="imagetoChange">
                            </div>
