...
@section('title')
{{ isset($post) ? 'Edit Thought ' . '"' . $post->title . '". | Nagrik Unmukti PartyDetails' : 'Create New Thought | Nagrik Unmukti PartyDetails' }}
...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">
        {{ isset($post) ? 'Edit New Thought' : 'Create New Thought' }}
    </h2>
