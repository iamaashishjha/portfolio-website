...
@section('content')
    ...
    <section class="fact-one">
        <div class="container text-center">
            ...
            <h3 class="fact-one__title counter">
                {{ isset($companyDetails->total_members) ? $companyDetails->total_members : '4,68,980' }}</h3>
            ...
            <div class="container">
                <div class="inner-container thm-base-bg-2">
                    <div class="row d-flex justify-content-center">
                        <a href="{{ route('home.donation') }}" class="thm-btn donation-contribute__btn">आर्थिक सहयोग
                            गर्नुहोस </a>
                    </div><!-- /.row -->
                </div><!-- /.inner-container -->
            </div><!-- /.container -->
    ...
    <section class="campaing-one">
        <div class="container">
            ...
            <p class="campaing-one__more-text text-center">{{ __('home.campaign.pre-button') }}<a
                    href="{{ route('home.member.create') }}" class="ml-2">{{ __('home.campaign.button') }}</a></p>
                    ...
                    <div class="accrodion-grp" data-grp-name="faq-accrodion">
                        <div class="accrodion active">
                            <div class="accrodion-title">
                                <h4>{{ isset($companyDetails->home_about_accordion_title_1) ? $companyDetails->home_about_accordion_title_1 : '' }}
                                </h4>
                            </div>
                        ...
                        <div class="accrodion ">
                            <div class="accrodion-title">
                                <h4>{{ isset($companyDetails->home_about_accordion_title_2) ? $companyDetails->home_about_accordion_title_2 : '' }}
                                </h4>
                            </div>
                            <div class="accrodion-content">
                                <div class="inner">
                        ...
                        <div class="accrodion">
                            <div class="accrodion-title">
                                <h4>{{ isset($companyDetails->home_about_accordion_title_3) ? $companyDetails->home_about_accordion_title_3 : '' }}
                                </h4>
                            </div>
                            <div class="accrodion-content">
                                <div class="inner">
    ...
    <section class="mailchimp-one">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <form class="mailchimp-one__form mc-form" method="POST"
                        action="{{ route('home.SubscribeUsForm') }}">
                        <input placeholder="Email Address" type="email" required="required" class="formInput"
                            name="subscribe_us_email">
                        <button type="submit"
                            class="thm-btn mailchimp-one__form-btn">{{ __('home.subscribe-mail.button') }}</button>
                    </form>
