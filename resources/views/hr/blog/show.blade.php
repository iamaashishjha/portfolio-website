...
<head>
    ...
    <!-- Favicon 
    ==================================================-->
    <link rel="icon" type="/hr/image/png" sizes="32x32" href="/hr/images/favicon.ico">
            ...
            <header class="main_nav">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light w-100">
                        <a class="navbar-brand p_0" href="#top"><img class="nav-logo" src="/hr/images/logo/1.png" alt="logo"></a>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-lg-8">
                            <div class="blog_details">
                                <div class="blog_img overlay_one wow animated slideInUp"><img src="/hr/images/blog/01.jpg" alt="image"></div>
                                    ...
                                    <ul class="user_comments">
                                        <li class="mb_20 wow animated slideInUp">
                                            <div class="comment_description bg_white p_20">
                                                <div class="author_img">
                                                    <img src="/hr/images/comments/01.png" alt="images">
                                                </div>
                                        ...
                                        <li class="mb_20 wow animated slideInUp">
                                            <div class="comment_description replied bg_white p_20">
                                                <div class="author_img">
                                                    <img src="/hr/images/comments/02.png" alt="images">
                                                </div>
                                                <div class="author_text">
                                                    <div class="author_info">
                                        ...
                                        <li class="mb_20 wow animated slideInUp">
                                            <div class="comment_description bg_white p_20">
                                                <div class="author_img">
                                                    <img src="/hr/images/comments/03.png" alt="images">
                                                </div>
                                                <div class="author_text">
                                                    <div class="author_info">
                                        ...
                                        <li class="mb_20 wow animated slideInUp">
                                            <div class="comment_description bg_white p_20">
                                                <div class="author_img">
                                                    <img src="/hr/images/comments/04.png" alt="images">
                                                </div>
                                                <div class="author_text">
                                                    <div class="author_info">
                                ...
                                <div class="widget mb_60 d-inline-block p_30 primary_link bg_white full_row wow animated slideInUp">
                                    ...
                                    <div class="recent_post">
                                        <ul>
                                            <li class="mb_30">
                                                <a href="#">
                                                    <div class="post_img"><img src="/hr/images/recent-post/01.jpg" alt="images"></div>
                                            ...
                                            <li class="mb_30">
                                                <a href="#">
                                                    <div class="post_img"><img src="/hr/images/recent-post/02.jpg" alt="images"></div>
                                                    <div class="recent_post_content">
                                            ...
                                            <li class="mb_30">
                                                <a href="#">
                                                    <div class="post_img"><img src="/hr/images/recent-post/03.jpg" alt="images"></div>
                                                    <div class="recent_post_content">
                                            ...
                                            <li class="mb_30">
                                                <a href="#">
                                                    <div class="post_img"><img src="/hr/images/recent-post/04.jpg" alt="images"></div>
                                                    <div class="recent_post_content">
