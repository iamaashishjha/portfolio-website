        ...
        <div class="content">
            ...
            <form action="{{ route('home.member.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="intro-y box pb-10 sm:py-20">
                    ...
                    <div class="px-5 sm:px-20 pt-10 border-t border-gray-200 tab-content__pane"
                        id="citizenship-content">
                        ...
                        <div class="grid grid-cols-12 gap-2 ">
                            ...
                            <div class=" col-span-12 lg:col-span-4">
                                ...
                                <input type="text"
                                    class="intro-y input input--lg w-full box pr-10 placeholder-theme-13 ml-2 mt-2"
                        ...
                        <div class="grid grid-cols-12 gap-2">
                            <div class="col-span-12 lg:col-span-4">
                                <div class="mt-3">
                                    <div
                                        class="font-medium  @error('email') text-theme-6 @enderror  flex items-center">
                                        Email
                                        <span
                                            class="text-lg ext-theme-9 text-theme-6 font-medium leading-none ml-1">*</span>
                                    </div>
                                    <div class="">
                                        <input type="text"
                                            ...
                                            placeholder="Write Email Address (Email लेख्नुहोस |)" name="email"
                                            id="email"
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="">
                                        <input type="text"
                                            ...
                                            placeholder="Write Phone Number (फोन न. लेखनुहोस् | )" name="phone_number"
                                            id="phone_number"
