    ...
    <div class="container">
        <div class="inner-container">
            <div class="topbar-one__left">
                <a
                    href="mailto:{{ isset($companyDetails->email_address) ? $companyDetails->email_address : 'needhelp@potisen.com' }}">{{ isset($companyDetails->email_address) ? $companyDetails->email_address : 'needhelp@potisen.com' }}</a>
                <a
                    href="tel:{{ isset($companyDetails->phone_number) ? $companyDetails->phone_number : '666 888 0000' }}">{{ isset($companyDetails->phone_number) ? $companyDetails->phone_number : '666 888 0000' }}</a>
            ...
            <div class="topbar-one__right">
                ...
                <div class="header-social text-center">
                    {!! isset($companyDetails->twitter_link)
                        ? '<a href="' . $companyDetails->twitter_link . ' "><i class="fa fa-twitter"></i></a>'
                        : '' !!}
                    {!! isset($companyDetails->facebook_link)
                        ? '<a href="' . $companyDetails->facebook_link . ' "><i class="fa fa-facebook-square"></i></a>'
                        : '' !!}
                    {!! isset($companyDetails->instagram_link)
                        ? '<a href="' . $companyDetails->instagram_link . ' "><i class="fa fa-instagram"></i></a>'
                        : '' !!}
        ...
        <div class="container clearfix">
            ...
            <div class="main-navigation">
                <ul class=" navigation-box">
                    ...
                    <li
                        class="{{ $url === 'blogs' || $url === 'events' || $url === 'library' ? 'current' : '' }}">
                        <a href="javascript:;">{{ __('home.menuItems.pages') }}</a>
                        <ul class="sub-menu">
                            <li><a href="{{ route('home.events.index') }}">{{ __('home.menuItems.posts.events') }}</a>
                            </li>
                            <li><a href="{{ route('home.blogs.index') }}">{{ __('home.menuItems.posts.blogs') }}</a>
                            </li>
                            <li>
