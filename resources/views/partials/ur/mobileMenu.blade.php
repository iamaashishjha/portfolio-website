...
<div class="mobile-menu md:hidden">
    ...
    <ul class="border-t border-theme-24 py-5 hidden">
        ...
        <li>
            ...
            <ul class="collapse">
                <li>
                    <a href="{{ route('admin.blog.post.create') }}" class="menu" id="blog_submenu">
                        <div class="menu__icon"> <i data-feather="activity"></i> </div>
                        <div class="menu__title"> Create New Post </div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.blog.post.index') }}" class="menu" id="blog_submenu">
                ...
                <li>
                    <a href="{{ route('admin.blog.post.trashed') }}" class="menu" id="blog_submenu">
                ...
                <li>
                    <a href="{{ route('admin.blog.category.index') }}" class="menu" id="blog_submenu">
                ...
                <li>
                    <a href="{{ route('admin.blog.tag.index') }}" class="menu" id="blog_submenu">
